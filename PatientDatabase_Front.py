...
#===================================================================================================================================================================================================================================                
        ...
        def count():
            count=str(int(patientlist.size()/2))
            self.lblcount = Label(ButtonFrame ,font=('arial', 8,'bold'),text="Count:"+count,bg="#535356")
        ...
        def clearData():
            ...
            Sputeum_specimen.set(OptionsSputeumspecimen[0])
...
#=============================================================================================================================================================================================================================================
        ...
        self.txtSputeum = OptionMenu(DataFrameRIGHT,Sputeum_specimen,*OptionsSputeumspecimen)
        ...
        self.txtOrganism = Entry(DataFrameRIGHT,font=('arial', 15,'bold'),textvariable=Organism,width=39,bg="#535356",fg="#d7d7d7")
